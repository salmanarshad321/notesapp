(function() {
  ...
  btn.id = 'salmanBtn';
  btn.style.cssText = 'background-color: red; color: white; border: 1px solid red; width: 90px; height: 50px; border-radius: 2px; top: 5px; padding: 5px; position: absolute; z-index: 999999;';
